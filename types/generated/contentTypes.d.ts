...
export interface ApiAdressAdress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    externalNumber: Schema.Attribute.String;
    internalNumber: Schema.Attribute.String;
...
export interface ApiDeliveryAssigmentDeliveryAssigment
  extends Struct.CollectionTypeSchema {
  collectionName: 'delivery_assigments';
  info: {
    displayName: 'deliveryAssigment';
    pluralName: 'delivery-assigments';
    singularName: 'delivery-assigment';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    deliveryUser: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    statusDelivery: Schema.Attribute.Enumeration<
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    unitSnapshot: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adress: Schema.Attribute.Relation<'manyToOne', 'api::adress.adress'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    deliveryAssigment: Schema.Attribute.Relation<
      'oneToOne',
      'api::delivery-assigment.delivery-assigment'
    >;
